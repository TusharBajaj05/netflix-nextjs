...
export default function MovieCard({title, overview, movieId, watchList, watchListId, youtubeUrl,age, time, year} : AppProps){
    const [open, setOpen] = useState(false);
    const pathName = usePathname();
    return(
        <>
            <button className="-mt-14">
                <PlayCircle onClick={()=> setOpen(true)} className="h-20 w-20" />
            </button>
